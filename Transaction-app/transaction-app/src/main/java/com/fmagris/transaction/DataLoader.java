package com.fmagris.transaction;
...
import com.fmagris.transaction.infrastructure.adapters.out.persistence.repositories.AccountTypeRepository;
...
// Create Account
    ...
    public static MovementsEntity createMovements_01() {
    ...
    public static MovementsEntity createMovements_02() {
